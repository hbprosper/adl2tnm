...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::otreestream*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("otreestream", "treestream.h", 371,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::Electron_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::Electron_s", "eventBuffer.h", 464,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::FatJet_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::FatJet_s", "eventBuffer.h", 591,
...
namespace ROOT {
   static TClass *eventBuffercLcLGenDressedLepton_s_Dictionary();
   static void eventBuffercLcLGenDressedLepton_s_TClassManip(TClass*);
   static void *new_eventBuffercLcLGenDressedLepton_s(void *p = 0);
   static void *newArray_eventBuffercLcLGenDressedLepton_s(Long_t size, void *p);
   static void delete_eventBuffercLcLGenDressedLepton_s(void *p);
   static void deleteArray_eventBuffercLcLGenDressedLepton_s(void *p);
   static void destruct_eventBuffercLcLGenDressedLepton_s(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::GenDressedLepton_s*)
   {
      ::eventBuffer::GenDressedLepton_s *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::eventBuffer::GenDressedLepton_s));
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::GenDressedLepton_s", "eventBuffer.h", 668,
                  typeid(::eventBuffer::GenDressedLepton_s), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &eventBuffercLcLGenDressedLepton_s_Dictionary, isa_proxy, 0,
                  sizeof(::eventBuffer::GenDressedLepton_s) );
      instance.SetNew(&new_eventBuffercLcLGenDressedLepton_s);
      instance.SetNewArray(&newArray_eventBuffercLcLGenDressedLepton_s);
      instance.SetDelete(&delete_eventBuffercLcLGenDressedLepton_s);
      instance.SetDeleteArray(&deleteArray_eventBuffercLcLGenDressedLepton_s);
      instance.SetDestructor(&destruct_eventBuffercLcLGenDressedLepton_s);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::eventBuffer::GenDressedLepton_s*)
   {
      return GenerateInitInstanceLocal((::eventBuffer::GenDressedLepton_s*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::eventBuffer::GenDressedLepton_s*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *eventBuffercLcLGenDressedLepton_s_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::eventBuffer::GenDressedLepton_s*)0x0)->GetClass();
      eventBuffercLcLGenDressedLepton_s_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::GenJet_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::GenJet_s", "eventBuffer.h", 689,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::GenJetAK8_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::GenJetAK8_s", "eventBuffer.h", 712,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::GenPart_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::GenPart_s", "eventBuffer.h", 735,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::GenVisTau_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::GenVisTau_s", "eventBuffer.h", 762,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::IsoTrack_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::IsoTrack_s", "eventBuffer.h", 787,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::Jet_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::Jet_s", "eventBuffer.h", 826,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::Muon_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::Muon_s", "eventBuffer.h", 901,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::Photon_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::Photon_s", "eventBuffer.h", 1000,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::SV_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::SV_s", "eventBuffer.h", 1069,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::SoftActivityJet_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::SoftActivityJet_s", "eventBuffer.h", 1104,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::SubGenJetAK8_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::SubGenJetAK8_s", "eventBuffer.h", 1121,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::SubJet_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::SubJet_s", "eventBuffer.h", 1140,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::eventBuffer::Tau_s*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("eventBuffer::Tau_s", "eventBuffer.h", 1179,
...
namespace ROOT {
   static void *new_TNMObject(void *p = 0);
   static void *newArray_TNMObject(Long_t size, void *p);
   static void delete_TNMObject(void *p);
   static void deleteArray_TNMObject(void *p);
   static void destruct_TNMObject(void *p);
   static void streamer_TNMObject(TBuffer &buf, void *obj);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TNMObject*)
   {
      ::TNMObject *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TNMObject >(0);
      static ::ROOT::TGenericClassInfo 
         instance("TNMObject", ::TNMObject::Class_Version(), "TNMObject.h", 40,
                  typeid(::TNMObject), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::TNMObject::Dictionary, isa_proxy, 16,
                  sizeof(::TNMObject) );
      instance.SetNew(&new_TNMObject);
      instance.SetNewArray(&newArray_TNMObject);
      instance.SetDelete(&delete_TNMObject);
      instance.SetDeleteArray(&deleteArray_TNMObject);
      instance.SetDestructor(&destruct_TNMObject);
      instance.SetStreamerFunc(&streamer_TNMObject);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TNMObject*)
   {
      return GenerateInitInstanceLocal((::TNMObject*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TNMObject*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static TClass *TNMThing_Dictionary();
   static void TNMThing_TClassManip(TClass*);
   static void *new_TNMThing(void *p = 0);
   static void *newArray_TNMThing(Long_t size, void *p);
   static void delete_TNMThing(void *p);
   static void deleteArray_TNMThing(void *p);
   static void destruct_TNMThing(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TNMThing*)
   {
      ::TNMThing *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::TNMThing));
      static ::ROOT::TGenericClassInfo 
         instance("TNMThing", "analyzer_s.h", 27,
                  typeid(::TNMThing), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &TNMThing_Dictionary, isa_proxy, 0,
                  sizeof(::TNMThing) );
      instance.SetNew(&new_TNMThing);
      instance.SetNewArray(&newArray_TNMThing);
      instance.SetDelete(&delete_TNMThing);
      instance.SetDeleteArray(&deleteArray_TNMThing);
      instance.SetDestructor(&destruct_TNMThing);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TNMThing*)
   {
      return GenerateInitInstanceLocal((::TNMThing*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TNMThing*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TNMThing_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TNMThing*)0x0)->GetClass();
      TNMThing_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   static TClass *analyzer_s_Dictionary();
   static void analyzer_s_TClassManip(TClass*);
   static void *new_analyzer_s(void *p = 0);
   static void *newArray_analyzer_s(Long_t size, void *p);
   static void delete_analyzer_s(void *p);
   static void deleteArray_analyzer_s(void *p);
   static void destruct_analyzer_s(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::analyzer_s*)
   {
      ::analyzer_s *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::analyzer_s));
      static ::ROOT::TGenericClassInfo 
         instance("analyzer_s", "analyzer_s.h", 37,
                  typeid(::analyzer_s), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &analyzer_s_Dictionary, isa_proxy, 0,
                  sizeof(::analyzer_s) );
      instance.SetNew(&new_analyzer_s);
      instance.SetNewArray(&newArray_analyzer_s);
      instance.SetDelete(&delete_analyzer_s);
      instance.SetDeleteArray(&deleteArray_analyzer_s);
      instance.SetDestructor(&destruct_analyzer_s);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::analyzer_s*)
   {
      return GenerateInitInstanceLocal((::analyzer_s*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::analyzer_s*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *analyzer_s_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::analyzer_s*)0x0)->GetClass();
      analyzer_s_TClassManip(theClass);
   return theClass;
   }
...
atomic_TClass_ptr TNMObject::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *TNMObject::Class_Name()
{
   return "TNMObject";
}

//______________________________________________________________________________
const char *TNMObject::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TNMObject*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TNMObject::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TNMObject*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *TNMObject::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TNMObject*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *TNMObject::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TNMObject*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_eventBuffercLcLGenDressedLepton_s(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::eventBuffer::GenDressedLepton_s : new ::eventBuffer::GenDressedLepton_s;
   }
   static void *newArray_eventBuffercLcLGenDressedLepton_s(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::eventBuffer::GenDressedLepton_s[nElements] : new ::eventBuffer::GenDressedLepton_s[nElements];
   }
   // Wrapper around operator delete
   static void delete_eventBuffercLcLGenDressedLepton_s(void *p) {
      delete ((::eventBuffer::GenDressedLepton_s*)p);
   }
   static void deleteArray_eventBuffercLcLGenDressedLepton_s(void *p) {
      delete [] ((::eventBuffer::GenDressedLepton_s*)p);
   }
   static void destruct_eventBuffercLcLGenDressedLepton_s(void *p) {
      typedef ::eventBuffer::GenDressedLepton_s current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::eventBuffer::GenDressedLepton_s
...
//______________________________________________________________________________
void TNMObject::Streamer(TBuffer &R__b)
{
   // Stream an object of class TNMObject.
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_TNMObject(void *p) {
      return  p ? new(p) ::TNMObject : new ::TNMObject;
   }
   static void *newArray_TNMObject(Long_t nElements, void *p) {
      return p ? new(p) ::TNMObject[nElements] : new ::TNMObject[nElements];
   }
   // Wrapper around operator delete
   static void delete_TNMObject(void *p) {
      delete ((::TNMObject*)p);
   ...
   static void destruct_TNMObject(void *p) {
      typedef ::TNMObject current_t;
      ((current_t*)p)->~current_t();
   }
   // Wrapper around a custom streamer member function.
   static void streamer_TNMObject(TBuffer &buf, void *obj) {
      ((::TNMObject*)obj)->::TNMObject::Streamer(buf);
   }
} // end of namespace ROOT for class ::TNMObject

namespace ROOT {
   // Wrappers around operator new
   static void *new_TNMThing(void *p) {
      return  p ? new(p) ::TNMThing : new ::TNMThing;
   }
   static void *newArray_TNMThing(Long_t nElements, void *p) {
      return p ? new(p) ::TNMThing[nElements] : new ::TNMThing[nElements];
   }
   // Wrapper around operator delete
   static void delete_TNMThing(void *p) {
      delete ((::TNMThing*)p);
   ...
   static void destruct_TNMThing(void *p) {
      typedef ::TNMThing current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::TNMThing

namespace ROOT {
   // Wrappers around operator new
   static void *new_analyzer_s(void *p) {
      return  p ? new(p) ::analyzer_s : new ::analyzer_s;
   }
   static void *newArray_analyzer_s(Long_t nElements, void *p) {
      return p ? new(p) ::analyzer_s[nElements] : new ::analyzer_s[nElements];
   }
   // Wrapper around operator delete
   static void delete_analyzer_s(void *p) {
      delete ((::analyzer_s*)p);
   ...
   static void destruct_analyzer_s(void *p) {
      typedef ::analyzer_s current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::analyzer_s
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::Tau_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::Tau_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::SubJet_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::SubJet_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::SubGenJetAK8_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::SubGenJetAK8_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::SoftActivityJet_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::SoftActivityJet_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::SV_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::SV_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::Photon_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::Photon_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::Muon_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::Muon_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::Jet_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::Jet_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::IsoTrack_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::IsoTrack_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::GenVisTau_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::GenVisTau_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::GenPart_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::GenPart_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::GenJet_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::GenJet_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::GenJetAK8_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::GenJetAK8_s>", -2, "vector", 458,
...
namespace ROOT {
   static TClass *vectorlEeventBuffercLcLGenDressedLepton_sgR_Dictionary();
   static void vectorlEeventBuffercLcLGenDressedLepton_sgR_TClassManip(TClass*);
   static void *new_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p = 0);
   static void *newArray_vectorlEeventBuffercLcLGenDressedLepton_sgR(Long_t size, void *p);
   static void delete_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p);
   static void deleteArray_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p);
   static void destruct_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::GenDressedLepton_s>*)
   {
      vector<eventBuffer::GenDressedLepton_s> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<eventBuffer::GenDressedLepton_s>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::GenDressedLepton_s>", -2, "vector", 458,
                  typeid(vector<eventBuffer::GenDressedLepton_s>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEeventBuffercLcLGenDressedLepton_sgR_Dictionary, isa_proxy, 4,
                  sizeof(vector<eventBuffer::GenDressedLepton_s>) );
      instance.SetNew(&new_vectorlEeventBuffercLcLGenDressedLepton_sgR);
      instance.SetNewArray(&newArray_vectorlEeventBuffercLcLGenDressedLepton_sgR);
      instance.SetDelete(&delete_vectorlEeventBuffercLcLGenDressedLepton_sgR);
      instance.SetDeleteArray(&deleteArray_vectorlEeventBuffercLcLGenDressedLepton_sgR);
      instance.SetDestructor(&destruct_vectorlEeventBuffercLcLGenDressedLepton_sgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<eventBuffer::GenDressedLepton_s> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<eventBuffer::GenDressedLepton_s>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEeventBuffercLcLGenDressedLepton_sgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<eventBuffer::GenDressedLepton_s>*)0x0)->GetClass();
      vectorlEeventBuffercLcLGenDressedLepton_sgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<eventBuffer::GenDressedLepton_s> : new vector<eventBuffer::GenDressedLepton_s>;
   }
   static void *newArray_vectorlEeventBuffercLcLGenDressedLepton_sgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<eventBuffer::GenDressedLepton_s>[nElements] : new vector<eventBuffer::GenDressedLepton_s>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p) {
      delete ((vector<eventBuffer::GenDressedLepton_s>*)p);
   }
   static void deleteArray_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p) {
      delete [] ((vector<eventBuffer::GenDressedLepton_s>*)p);
   }
   static void destruct_vectorlEeventBuffercLcLGenDressedLepton_sgR(void *p) {
      typedef vector<eventBuffer::GenDressedLepton_s> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<eventBuffer::GenDressedLepton_s>
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::FatJet_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::FatJet_s>", -2, "vector", 458,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<eventBuffer::Electron_s>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<eventBuffer::Electron_s>", -2, "vector", 458,
...
namespace ROOT {
   static TClass *vectorlETNMObjectgR_Dictionary();
   static void vectorlETNMObjectgR_TClassManip(TClass*);
   static void *new_vectorlETNMObjectgR(void *p = 0);
   static void *newArray_vectorlETNMObjectgR(Long_t size, void *p);
   static void delete_vectorlETNMObjectgR(void *p);
   static void deleteArray_vectorlETNMObjectgR(void *p);
   static void destruct_vectorlETNMObjectgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TNMObject>*)
   {
      vector<TNMObject> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<TNMObject>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<TNMObject>", -2, "vector", 458,
                  typeid(vector<TNMObject>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlETNMObjectgR_Dictionary, isa_proxy, 4,
                  sizeof(vector<TNMObject>) );
      instance.SetNew(&new_vectorlETNMObjectgR);
      instance.SetNewArray(&newArray_vectorlETNMObjectgR);
      instance.SetDelete(&delete_vectorlETNMObjectgR);
      instance.SetDeleteArray(&deleteArray_vectorlETNMObjectgR);
      instance.SetDestructor(&destruct_vectorlETNMObjectgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<TNMObject> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<TNMObject>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlETNMObjectgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<TNMObject>*)0x0)->GetClass();
      vectorlETNMObjectgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlETNMObjectgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<TNMObject> : new vector<TNMObject>;
   }
   static void *newArray_vectorlETNMObjectgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<TNMObject>[nElements] : new vector<TNMObject>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlETNMObjectgR(void *p) {
      delete ((vector<TNMObject>*)p);
   }
   static void deleteArray_vectorlETNMObjectgR(void *p) {
      delete [] ((vector<TNMObject>*)p);
   }
   static void destruct_vectorlETNMObjectgR(void *p) {
      typedef vector<TNMObject> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<TNMObject>
...
"/Users/harry/external/root/include",
"/Users/harry/external/root/include",
"/Users/harry/Projects/ADL/adl2tnm/examples/razorboost/analyzer/",
0
    };
...
struct __attribute__((annotate("$clingAutoload$TNMObject.h")))  __attribute__((annotate("$clingAutoload$include/analyzer_s.h")))  TNMObject;
...
struct __attribute__((annotate("$clingAutoload$include/analyzer_s.h")))  TNMThing;
struct __attribute__((annotate("$clingAutoload$include/analyzer_s.h")))  analyzer_s;
)DICTFWDDCLS";
...
"TNMObject", payloadCode, "@",
"TNMThing", payloadCode, "@",
"analyzer_s", payloadCode, "@",
"change", payloadCode, "@",
...
"eventBuffer::GenDressedLepton_s", payloadCode, "@",
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("dictionary",
        ...
        TriggerDictionaryInitialization_dictionary_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
