...
// Created:     Sun May  5 21:48:25 2019 by mkanalyzer.py v2.0.2 15-Apr-2019
...
struct eventBuffer
{
  ...
  void initBuffers()
  {
    Electron_charge	= std::vector<int>(30,0);
    Electron_cleanmask	= std::vector<int>(30,0);
    Electron_convVeto	= std::vector<bool>(30,0);
    Electron_cutBased	= std::vector<int>(30,0);
    Electron_cutBased_Fall17_V1	= std::vector<int>(30,0);
    Electron_cutBased_HEEP	= std::vector<bool>(30,0);
    Electron_deltaEtaSC	= std::vector<float>(30,0);
    Electron_dr03EcalRecHitSumEt	= std::vector<float>(30,0);
    Electron_dr03HcalDepth1TowerSumEt	= std::vector<float>(30,0);
    Electron_dr03TkSumPt	= std::vector<float>(30,0);
    Electron_dr03TkSumPtHEEP	= std::vector<float>(30,0);
    Electron_dxy	= std::vector<float>(30,0);
    Electron_dxyErr	= std::vector<float>(30,0);
    Electron_dz	= std::vector<float>(30,0);
    Electron_dzErr	= std::vector<float>(30,0);
    Electron_eCorr	= std::vector<float>(30,0);
    Electron_eInvMinusPInv	= std::vector<float>(30,0);
    Electron_energyErr	= std::vector<float>(30,0);
    Electron_eta	= std::vector<float>(30,0);
    Electron_genPartFlav	= std::vector<int>(30,0);
    Electron_genPartIdx	= std::vector<int>(30,0);
    Electron_hoe	= std::vector<float>(30,0);
    Electron_ip3d	= std::vector<float>(30,0);
    Electron_isPFcand	= std::vector<bool>(30,0);
    Electron_jetIdx	= std::vector<int>(30,0);
    Electron_jetRelIso	= std::vector<float>(30,0);
    Electron_lostHits	= std::vector<int>(30,0);
    Electron_mass	= std::vector<float>(30,0);
    Electron_miniPFRelIso_all	= std::vector<float>(30,0);
    Electron_miniPFRelIso_chg	= std::vector<float>(30,0);
    Electron_mvaFall17V1Iso	= std::vector<float>(30,0);
    Electron_mvaFall17V1Iso_WP80	= std::vector<bool>(30,0);
    Electron_mvaFall17V1Iso_WP90	= std::vector<bool>(30,0);
    Electron_mvaFall17V1Iso_WPL	= std::vector<bool>(30,0);
    Electron_mvaFall17V1noIso	= std::vector<float>(30,0);
    Electron_mvaFall17V1noIso_WP80	= std::vector<bool>(30,0);
    Electron_mvaFall17V1noIso_WP90	= std::vector<bool>(30,0);
    Electron_mvaFall17V1noIso_WPL	= std::vector<bool>(30,0);
    Electron_mvaFall17V2Iso	= std::vector<float>(30,0);
    Electron_mvaFall17V2Iso_WP80	= std::vector<bool>(30,0);
    Electron_mvaFall17V2Iso_WP90	= std::vector<bool>(30,0);
    Electron_mvaFall17V2Iso_WPL	= std::vector<bool>(30,0);
    Electron_mvaFall17V2noIso	= std::vector<float>(30,0);
    Electron_mvaFall17V2noIso_WP80	= std::vector<bool>(30,0);
    Electron_mvaFall17V2noIso_WP90	= std::vector<bool>(30,0);
    Electron_mvaFall17V2noIso_WPL	= std::vector<bool>(30,0);
    Electron_mvaTTH	= std::vector<float>(30,0);
    Electron_pdgId	= std::vector<int>(30,0);
    Electron_pfRelIso03_all	= std::vector<float>(30,0);
    Electron_pfRelIso03_chg	= std::vector<float>(30,0);
    Electron_phi	= std::vector<float>(30,0);
    Electron_photonIdx	= std::vector<int>(30,0);
    Electron_pt	= std::vector<float>(30,0);
    Electron_r9	= std::vector<float>(30,0);
    Electron_sieie	= std::vector<float>(30,0);
    Electron_sip3d	= std::vector<float>(30,0);
    Electron_tightCharge	= std::vector<int>(30,0);
    Electron_vidNestedWPBitmap	= std::vector<int>(30,0);
    ...
    GenJetAK8_eta	= std::vector<float>(30,0);
    GenJetAK8_hadronFlavour	= std::vector<int>(30,0);
    GenJetAK8_mass	= std::vector<float>(30,0);
    GenJetAK8_partonFlavour	= std::vector<int>(30,0);
    GenJetAK8_phi	= std::vector<float>(30,0);
    GenJetAK8_pt	= std::vector<float>(30,0);
    GenJet_eta	= std::vector<float>(65,0);
    GenJet_hadronFlavour	= std::vector<int>(65,0);
    GenJet_mass	= std::vector<float>(65,0);
    GenJet_partonFlavour	= std::vector<int>(65,0);
    GenJet_phi	= std::vector<float>(65,0);
    GenJet_pt	= std::vector<float>(65,0);
    GenPart_eta	= std::vector<float>(405,0);
    GenPart_genPartIdxMother	= std::vector<int>(405,0);
    GenPart_mass	= std::vector<float>(405,0);
    GenPart_pdgId	= std::vector<int>(405,0);
    GenPart_phi	= std::vector<float>(405,0);
    GenPart_pt	= std::vector<float>(405,0);
    GenPart_status	= std::vector<int>(405,0);
    GenPart_statusFlags	= std::vector<int>(405,0);
    ...
    Jet_area	= std::vector<float>(60,0);
    Jet_bRegCorr	= std::vector<float>(60,0);
    Jet_bRegRes	= std::vector<float>(60,0);
    Jet_btagCMVA	= std::vector<float>(60,0);
    Jet_btagCSVV2	= std::vector<float>(60,0);
    Jet_btagDeepB	= std::vector<float>(60,0);
    Jet_btagDeepC	= std::vector<float>(60,0);
    Jet_btagDeepFlavB	= std::vector<float>(60,0);
    Jet_chEmEF	= std::vector<float>(60,0);
    Jet_chHEF	= std::vector<float>(60,0);
    Jet_cleanmask	= std::vector<int>(60,0);
    Jet_electronIdx1	= std::vector<int>(60,0);
    Jet_electronIdx2	= std::vector<int>(60,0);
    Jet_eta	= std::vector<float>(60,0);
    Jet_genJetIdx	= std::vector<int>(60,0);
    Jet_hadronFlavour	= std::vector<int>(60,0);
    Jet_jetId	= std::vector<int>(60,0);
    Jet_mass	= std::vector<float>(60,0);
    Jet_muEF	= std::vector<float>(60,0);
    Jet_muonIdx1	= std::vector<int>(60,0);
    Jet_muonIdx2	= std::vector<int>(60,0);
    Jet_nConstituents	= std::vector<int>(60,0);
    Jet_nElectrons	= std::vector<int>(60,0);
    Jet_nMuons	= std::vector<int>(60,0);
    Jet_neEmEF	= std::vector<float>(60,0);
    Jet_neHEF	= std::vector<float>(60,0);
    Jet_partonFlavour	= std::vector<int>(60,0);
    Jet_phi	= std::vector<float>(60,0);
    Jet_pt	= std::vector<float>(60,0);
    Jet_puId	= std::vector<int>(60,0);
    Jet_qgl	= std::vector<float>(60,0);
    Jet_rawFactor	= std::vector<float>(60,0);
    ...
    Photon_charge	= std::vector<int>(35,0);
    Photon_cleanmask	= std::vector<int>(35,0);
    Photon_cutBasedBitmap	= std::vector<int>(35,0);
    Photon_cutBasedV1Bitmap	= std::vector<int>(35,0);
    Photon_eCorr	= std::vector<float>(35,0);
    Photon_electronIdx	= std::vector<int>(35,0);
    Photon_electronVeto	= std::vector<bool>(35,0);
    Photon_energyErr	= std::vector<float>(35,0);
    Photon_eta	= std::vector<float>(35,0);
    Photon_genPartFlav	= std::vector<int>(35,0);
    Photon_genPartIdx	= std::vector<int>(35,0);
    Photon_hoe	= std::vector<float>(35,0);
    Photon_isScEtaEB	= std::vector<bool>(35,0);
    Photon_isScEtaEE	= std::vector<bool>(35,0);
    Photon_jetIdx	= std::vector<int>(35,0);
    Photon_mass	= std::vector<float>(35,0);
    Photon_mvaID	= std::vector<float>(35,0);
    Photon_mvaIDV1	= std::vector<float>(35,0);
    Photon_mvaID_WP80	= std::vector<bool>(35,0);
    Photon_mvaID_WP90	= std::vector<bool>(35,0);
    Photon_pdgId	= std::vector<int>(35,0);
    Photon_pfRelIso03_all	= std::vector<float>(35,0);
    Photon_pfRelIso03_chg	= std::vector<float>(35,0);
    Photon_phi	= std::vector<float>(35,0);
    Photon_pixelSeed	= std::vector<bool>(35,0);
    Photon_pt	= std::vector<float>(35,0);
    Photon_r9	= std::vector<float>(35,0);
    Photon_sieie	= std::vector<float>(35,0);
    Photon_vidNestedWPBitmap	= std::vector<int>(35,0);
    SV_chi2	= std::vector<float>(60,0);
    SV_dlen	= std::vector<float>(60,0);
    SV_dlenSig	= std::vector<float>(60,0);
    SV_eta	= std::vector<float>(60,0);
    SV_mass	= std::vector<float>(60,0);
    SV_ndof	= std::vector<float>(60,0);
    SV_pAngle	= std::vector<float>(60,0);
    SV_phi	= std::vector<float>(60,0);
    SV_pt	= std::vector<float>(60,0);
    SV_x	= std::vector<float>(60,0);
    SV_y	= std::vector<float>(60,0);
    SV_z	= std::vector<float>(60,0);
    ...
    SubGenJetAK8_eta	= std::vector<float>(50,0);
    SubGenJetAK8_mass	= std::vector<float>(50,0);
    SubGenJetAK8_phi	= std::vector<float>(50,0);
    SubGenJetAK8_pt	= std::vector<float>(50,0);
    SubJet_btagCMVA	= std::vector<float>(40,0);
    SubJet_btagCSVV2	= std::vector<float>(40,0);
    SubJet_btagDeepB	= std::vector<float>(40,0);
    SubJet_eta	= std::vector<float>(40,0);
    SubJet_mass	= std::vector<float>(40,0);
    SubJet_n2b1	= std::vector<float>(40,0);
    SubJet_n3b1	= std::vector<float>(40,0);
    SubJet_phi	= std::vector<float>(40,0);
    SubJet_pt	= std::vector<float>(40,0);
    SubJet_rawFactor	= std::vector<float>(40,0);
    SubJet_tau1	= std::vector<float>(40,0);
    SubJet_tau2	= std::vector<float>(40,0);
    SubJet_tau3	= std::vector<float>(40,0);
    SubJet_tau4	= std::vector<float>(40,0);
    ...
    Electron	= std::vector<eventBuffer::Electron_s>(30);
    FatJet	= std::vector<eventBuffer::FatJet_s>(25);
    GenDressedLepton	= std::vector<eventBuffer::GenDressedLepton_s>(20);
    GenJet	= std::vector<eventBuffer::GenJet_s>(65);
    GenJetAK8	= std::vector<eventBuffer::GenJetAK8_s>(30);
    GenPart	= std::vector<eventBuffer::GenPart_s>(405);
    GenVisTau	= std::vector<eventBuffer::GenVisTau_s>(20);
    IsoTrack	= std::vector<eventBuffer::IsoTrack_s>(25);
    Jet	= std::vector<eventBuffer::Jet_s>(60);
    Muon	= std::vector<eventBuffer::Muon_s>(25);
    Photon	= std::vector<eventBuffer::Photon_s>(35);
    SV	= std::vector<eventBuffer::SV_s>(60);
    SoftActivityJet	= std::vector<eventBuffer::SoftActivityJet_s>(20);
    SubGenJetAK8	= std::vector<eventBuffer::SubGenJetAK8_s>(50);
    SubJet	= std::vector<eventBuffer::SubJet_s>(40);
